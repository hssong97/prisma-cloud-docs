...
.. Make sure that you have Account Owner or Contributor privileges so that you can add your Prisma Cloud created application on your Azure Active Directory. 
