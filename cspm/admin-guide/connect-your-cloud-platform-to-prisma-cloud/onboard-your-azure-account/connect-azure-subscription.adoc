...
Learn how to <<commercial>>, <<government>>, or Azure China cloud resources on Prisma Cloud. Onboarding an *Azure Subscription* connects the resources within your Azure subscription to Prisma Cloud.
...
[#commercial]
=== Add Azure Commercial Subscription
...
[#government]
=== Add Azure Government Subscription
