...
[NOTE]
====
If the userinput:[terraform.tfstate] file is not present in the directory, when the Terraform script is executed, a new app is registered and a new custom roles is created.
====
